...
!**********************************************************************
    ...
    CALL READROOTPARS(UWATPARS,ROOTRESFRAC, ROOTRADTABLE,ROOTSRLTABLE,ROOTMASSTOTTABLE, NROOTLAYER,FRACROOTTABLE, &
...
!**********************************************************************
SUBROUTINE READROOTPARS(UFILE, ROOTRESFRACI,ROOTRADTABLEI,ROOTSRLTABLEI, &  
