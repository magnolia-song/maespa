...
! Array declarations.
    ...
    ! Functions
    REAL, EXTERNAL :: AVERAGEVAL,CALCRMW,TK,ETCAN,RESP,GRESP,RELKWEIBULL,CALCXYLEMPSI
    ...
    !! Tree dimensions MAXT*MAXT array with sorted tree numbers
    INTEGER ITAD(MAXT,MAXT)
    ...
    ! Daily totals are now also tree arrays
    ...
    REAL P50,PLCSHAPE,PLCDEAD,STEMRELK
    INTEGER DEADALIVE(MAXDATE,MAXT)
    ...
    REAL ETMEASTOT, ETMMSPEC(MAXSP),ETMM, ETMM2, ETMMTOT, ETUSMM, ETMMNONSOIL
    REAL EVAPSTORE, EXPAN, EXPDIF, EXPINF, EXPONT
    ...
    REAL GSREF, HFX, GSMIN,RD0US,SLAUS, GNIGHT, GNIGHTSPEC(MAXSP)
    ...
    INTEGER NUMTESTPNT,NECHLAY
    LOGICAL ISMAESPA, ISNIGHT, ABORTSIMULATION
    ...
    REAL OUTFLOW, OVERFLOW, PAR, PAR0, PAROTC, PLANTK, PLANTKACT,KSCALING,PPTDAY, PPTTOT, PRESSK, PREVTSOIL, PSIL
    ...
    REAL PLANTWATER(MAXDATE, MAXT), PLANTWATER0(MAXDATE, MAXT),PLANTWMINVAL
    REAL XYLEMPSI(MAXDATE, MAXT)
