...
! Array declarations.
    ...
    !REAL DXTAD(MAXT,MAXT),DYTAD(MAXT,MAXT),DZTAD(MAXT,MAXT)
    !REAL RXTABLEAD(MAXDATE,MAXT,MAXT),RYTABLEAD(MAXDATE,MAXT,MAXT),RZTABLEAD(MAXDATE,MAXT,MAXT)
    !REAL FOLTABLEAD(MAXDATE,MAXT,MAXT),ZBCTABLEAD(MAXDATE,MAXT,MAXT),DIAMTABLEAD(MAXDATE,MAXT,MAXT)
    !INTEGER ISPECIESAD(MAXT,MAXT),ISPECIESTAD(MAXT,MAXT),
